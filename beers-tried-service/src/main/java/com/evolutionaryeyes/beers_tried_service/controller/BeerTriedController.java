...
public class BeerTriedController {
    ...
    public ResponseEntity<List<BeerTriedDTO>> getAllTriedBeerEvents() {
        return beerTriedService.getAllTriedBeerEvents();
    }

    @PostMapping("add")
    public ResponseEntity<BeerTriedDTO> createBeerTriedEvent(@RequestBody BeerTriedDTO beerTriedDTO) {
        return beerTriedService.createBeerTriedEvent(beerTriedDTO);

    }

    @PutMapping("update")
    public ResponseEntity<BeerTriedDTO> updateBeerTriedEvent(
            @RequestParam int beerItemId,
            @RequestParam int userId,
            @RequestBody BeerTriedDTO beerTriedDTO
    ) throws Exception {
        return beerTriedService.updateBeerTriedEvent(userId, beerItemId, beerTriedDTO);
    ...
    public ResponseEntity<List<BeerItemDTO>> getBeersTriedByUserId(
        ...
        return beerTriedService.getTriedBeerByUserId(userId);
    }
}
